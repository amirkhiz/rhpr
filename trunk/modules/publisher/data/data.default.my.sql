...
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'itemcategorymgr_cmd_insert', '', @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'itemcategorymgr_cmd_update', '', @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'itemcategorymgr_cmd_list', '', @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'itemcategorymgr', '', @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'itemcategorymgr_cmd_delete', '', @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'itemcategorymgr_cmd_reorder', NULL, @moduleId);
INSERT INTO permission VALUES ({SGL_NEXT_ID}, 'itemcategorymgr_cmd_reorderUpdate', NULL, @moduleId);
...
INSERT INTO item_category VALUES (1,'PublisherRoot',NULL,0,1,1,4,1,1);
