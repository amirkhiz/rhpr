...
/*==============================================================*/
/* Index: item_category_document_fk                                  */
/*==============================================================*/
create index item_category_document_fk on document
(
   item_category_id
);
...
/*==============================================================*/
/* Index: item_category_item_fk                                      */
/*==============================================================*/
create index item_category_item_fk on item
(
   item_category_id
);
...
create table if not exists item_category (
  ...
  KEY AK_id_root_l_r (item_category_id,root_id,left_id,right_id),
...
/* Index: parent_fk                                             */
/*==============================================================*/
create index parent_fk on item_category
(
   parent_id
);
