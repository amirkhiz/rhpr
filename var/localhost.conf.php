...
$conf['site']['globalJavascriptFiles'] = 'js/jquery.js,js/bootstrap.js,js/bootstrap-datepicker.js,js/bootstrap-timepicker.min.js,js/jquery/jquery.mask.js,js/jquery/jquery.sortable.js,js/jquery/plugins/jquery.chosen.js,js/bootstrap.switch.js,js/jquery/jquery-ui.js,js/SGL.js';
...
$conf['site']['baseUrl'] = 'http://localhost/rehber/www';
...
$conf['path']['installRoot'] = '/opt/lampp/htdocs/rehber';
$conf['path']['webRoot'] = '/opt/lampp/htdocs/rehber/www';
$conf['cookie']['path'] = '/';
$conf['cookie']['domain'] = '';
